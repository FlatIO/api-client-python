...
from flat_api.models.score_collaborator import ScoreCollaborator


class TestScoreCollaborator(unittest.TestCase):
    """ ScoreCollaborator unit test stubs """
    ...
    def testScoreCollaborator(self):
        """
        Test ScoreCollaborator
        """
        model = flat_api.models.score_collaborator.ScoreCollaborator()
