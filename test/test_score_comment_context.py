...
class TestScoreCommentContext(unittest.TestCase):
    ...
    def testScoreCommentContext(self):
        ...
        """
        model = flat_api.models.score_comment_context.ScoreCommentContext(
            part_uuid='8E9DEEC3-A14E-44CA-AFB2-9B8234BC5A44',
            staff_idx=0,
            measure_uuids=['2E5DA5F7-0DC5-42C8-AFE3-779170D42FFC'],
            start_time_pos=0,
            stop_time_pos=0,
            start_dpq=0,
            stop_dpq=0
