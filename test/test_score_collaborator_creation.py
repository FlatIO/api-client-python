...
from flat_api.models.score_collaborator_creation import ScoreCollaboratorCreation


class TestScoreCollaboratorCreation(unittest.TestCase):
    """ ScoreCollaboratorCreation unit test stubs """
    ...
    def testScoreCollaboratorCreation(self):
        """
        Test ScoreCollaboratorCreation
        """
        model = flat_api.models.score_collaborator_creation.ScoreCollaboratorCreation()
