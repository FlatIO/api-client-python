...
class TestScoreDataEncoding(unittest.TestCase):
    """ ScoreDataEncoding unit test stubs """
    ...
    def testScoreDataEncoding(self):
        """
        Test ScoreDataEncoding
        """
        model = flat_api.models.score_data_encoding.ScoreDataEncoding()
