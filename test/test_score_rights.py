...
from flat_api.models.score_rights import ScoreRights


class TestScoreRights(unittest.TestCase):
    """ ScoreRights unit test stubs """
    ...
    def testScoreRights(self):
        """
        Test ScoreRights
        """
        model = flat_api.models.score_rights.ScoreRights()
