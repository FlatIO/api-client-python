#!/usr/bin/env python3
"""Auto-pagination (FR-006f). Idempotent: writes a fixed file."""
...
(ROOT / "flat_api" / "pagination.py").write_text('''"""Cursor pagination for the Flat API.
...
def paginate(
    ...
    **kwargs: Any,
    ...
    while True:
        ...
        seen.add(cursor)
''')
print("    pagination: wrote flat_api/pagination.py")
