...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'now': typing.Union[NowSchema, bool, ],
    },
    total=False
)
...
request_query_now = api_client.QueryParameter(
    name="now",
...
class DeleteScore(BaseApi):
    ...
    def delete_score(
        ...
        return self._delete_score_oapg(
