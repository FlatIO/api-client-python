...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['EduLibrary']:
            return EduLibrary

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['EduLibrary'], typing.List['EduLibrary']],
    ...
    def __getitem__(self, i: int) -> 'EduLibrary':
...
class ListEduLibraries(BaseApi):
    ...
    def list_edu_libraries(
        ...
        return self._list_edu_libraries_oapg(
