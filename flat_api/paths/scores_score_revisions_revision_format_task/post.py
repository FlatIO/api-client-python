...
class FormatSchema(
    ...
    @schemas.classproperty
    def PRACTICEFIRST(cls):
        return cls("practicefirst")
...
# body param
SchemaForRequestBodyApplicationJson = TaskExportOptions
...
class CreateExportTask(BaseApi):
    ...
    def create_export_task(
        ...
        return self._create_export_task_oapg(
            body=body,
