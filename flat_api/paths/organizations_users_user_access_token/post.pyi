...
# body param
SchemaForRequestBodyApplicationJson = OrganizationUserAccessTokenCreation


request_body_organization_user_access_token_creation = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = ApiAccessToken
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_organization_user_access_token_oapg(
        self,
    ...
    def _create_organization_user_access_token_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_organization_user_access_token_creation.serialize(body, content_type)
...
class CreateOrganizationUserAccessToken(BaseApi):
    ...
    def create_organization_user_access_token(
        ...
        return self._create_organization_user_access_token_oapg(
            body=body,
