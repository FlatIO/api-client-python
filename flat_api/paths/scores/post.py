...
# body param
SchemaForRequestBodyApplicationJson = ScoreCreation
...
SchemaFor200ResponseBodyApplicationJson = ScoreDetails
...
class CreateScore(BaseApi):
    ...
    def create_score(
        ...
        return self._create_score_oapg(
            body=body,
