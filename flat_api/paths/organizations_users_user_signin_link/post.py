...
# body param
SchemaForRequestBodyApplicationJson = UserSigninLinkCreation


request_body_user_signin_link_creation = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = UserSigninLink
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_organization_user_signin_link_oapg(
        self,
    ...
    def _create_organization_user_signin_link_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_user_signin_link_creation.serialize(body, content_type)
...
class CreateOrganizationUserSigninLink(BaseApi):
    ...
    def create_organization_user_signin_link(
        ...
        return self._create_organization_user_signin_link_oapg(
            body=body,
