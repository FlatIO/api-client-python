...
# body param
SchemaForRequestBodyApplicationJson = EduResourceCreation


request_body_edu_resource_creation = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_edu_resource_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_edu_resource_creation.serialize(body, content_type)
...
class CreateEduResource(BaseApi):
    ...
    def create_edu_resource(
        ...
        return self._create_edu_resource_oapg(
            body=body,
