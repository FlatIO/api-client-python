...
# Path params
CredentialsSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'credentials': typing.Union[CredentialsSchema, str, ],
    }
)
...
request_path_credentials = api_client.PathParameter(
    name="credentials",
...
class BaseApi(api_client.Api):
    @typing.overload
    def _revoke_lti_credentials_oapg(
        self,
...
class RevokeLtiCredentials(BaseApi):
    ...
    def revoke_lti_credentials(
        ...
        return self._revoke_lti_credentials_oapg(
