...
SchemaFor0ResponseBodyApplicationVndOpenxmlformatsOfficedocumentSpreadsheetmlSheet = FlatErrorResponse
...
_response_for_default = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet': api_client.MediaType(
            schema=SchemaFor0ResponseBodyApplicationVndOpenxmlformatsOfficedocumentSpreadsheetmlSheet),
    },
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _export_submissions_reviews_as_excel_oapg(
        self,
...
class ExportSubmissionsReviewsAsExcel(BaseApi):
    ...
    def export_submissions_reviews_as_excel(
        ...
        return self._export_submissions_reviews_as_excel_oapg(
