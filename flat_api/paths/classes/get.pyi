...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ClassDetails']:
            return ClassDetails

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ClassDetails'], typing.List['ClassDetails']],
    ...
    def __getitem__(self, i: int) -> 'ClassDetails':
...
class ListClasses(BaseApi):
    ...
    def list_classes(
        ...
        return self._list_classes_oapg(
