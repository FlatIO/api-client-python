...
# body param
SchemaForRequestBodyApplicationJson = LtiCredentialsCreation
...
SchemaFor200ResponseBodyApplicationJson = LtiCredentials
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_lti_credentials_oapg(
        self,
...
class CreateLtiCredentials(BaseApi):
    ...
    def create_lti_credentials(
        ...
        return self._create_lti_credentials_oapg(
            body=body,
