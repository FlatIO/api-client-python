...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['LtiCredentials']:
            return LtiCredentials

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['LtiCredentials'], typing.List['LtiCredentials']],
    ...
    def __getitem__(self, i: int) -> 'LtiCredentials':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_lti_credentials_oapg(
        self,
...
class ListLtiCredentials(BaseApi):
    ...
    def list_lti_credentials(
        ...
        return self._list_lti_credentials_oapg(
