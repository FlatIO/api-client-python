...
ListAutoTrackSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'listAutoTrack': typing.Union[ListAutoTrackSchema, bool, ],
    },
    total=False
)
...
request_query_assignment = api_client.QueryParameter(
    name="assignment",
    style=api_client.ParameterStyle.FORM,
    schema=AssignmentSchema,
    explode=True,
)
request_query_list_auto_track = api_client.QueryParameter(
    name="listAutoTrack",
    style=api_client.ParameterStyle.FORM,
    schema=ListAutoTrackSchema,
    explode=True,
)
# Path params
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ScoreTrack']:
            return ScoreTrack

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ScoreTrack'], typing.List['ScoreTrack']],
    ...
    def __getitem__(self, i: int) -> 'ScoreTrack':
...
class BaseApi(api_client.Api):
    ...
    def _list_score_tracks_oapg(
        ...
        for parameter in (
            ...
            request_query_assignment,
            request_query_list_auto_track,
        ):
...
class ListScoreTracks(BaseApi):
    ...
    def list_score_tracks(
        ...
        return self._list_score_tracks_oapg(
