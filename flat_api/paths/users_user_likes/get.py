...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'ids': typing.Union[IdsSchema, bool, ],
    },
    total=False
)
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ScoreDetails']:
            return ScoreDetails

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ScoreDetails'], typing.List['ScoreDetails']],
    ...
    def __getitem__(self, i: int) -> 'ScoreDetails':
...
class GerUserLikes(BaseApi):
    ...
    def ger_user_likes(
        ...
        return self._ger_user_likes_oapg(
