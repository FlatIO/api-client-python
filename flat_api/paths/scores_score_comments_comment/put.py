...
# body param
SchemaForRequestBodyApplicationJson = ScoreCommentUpdate
...
SchemaFor200ResponseBodyApplicationJson = ScoreComment
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_score_comment_oapg(
        self,
...
class UpdateScoreComment(BaseApi):
    ...
    def update_score_comment(
        ...
        return self._update_score_comment_oapg(
            body=body,
