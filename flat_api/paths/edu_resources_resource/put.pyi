...
# body param
SchemaForRequestBodyApplicationJson = EduResourceUpdate


request_body_edu_resource_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = EduResource
...
class BaseApi(api_client.Api):
    ...
    def _update_edu_resource_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_edu_resource_update.serialize(body, content_type)
...
class UpdateEduResource(BaseApi):
    ...
    def update_edu_resource(
        ...
        return self._update_edu_resource_oapg(
            body=body,
