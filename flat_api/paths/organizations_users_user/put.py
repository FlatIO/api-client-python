...
# body param
SchemaForRequestBodyApplicationJson = UserAdminUpdate
...
SchemaFor200ResponseBodyApplicationJson = UserDetailsAdmin
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_organization_user_oapg(
        self,
...
class UpdateOrganizationUser(BaseApi):
    ...
    def update_organization_user(
        ...
        return self._update_organization_user_oapg(
            body=body,
