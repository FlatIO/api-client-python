...
# Query params
ConvertToIndividualSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'convertToIndividual': typing.Union[ConvertToIndividualSchema, bool, ],
    },
    total=False
)
...
request_query_convert_to_individual = api_client.QueryParameter(
    name="convertToIndividual",
    style=api_client.ParameterStyle.FORM,
    schema=ConvertToIndividualSchema,
    explode=True,
)
# Path params
...
class BaseApi(api_client.Api):
    ...
    def _remove_organization_user_oapg(
        ...
        for parameter in (
            request_query_convert_to_individual,
        ):
