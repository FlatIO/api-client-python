...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['UserPublic']:
            return UserPublic

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['UserPublic'], typing.List['UserPublic']],
    ...
    def __getitem__(self, i: int) -> 'UserPublic':
...
class ListGroupUsers(BaseApi):
    ...
    def list_group_users(
        ...
        return self._list_group_users_oapg(
