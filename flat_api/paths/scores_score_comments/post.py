...
# body param
SchemaForRequestBodyApplicationJson = ScoreCommentCreation
...
class PostScoreComment(BaseApi):
    ...
    def post_score_comment(
        ...
        return self._post_score_comment_oapg(
            body=body,
