...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ScoreComment']:
            return ScoreComment

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ScoreComment'], typing.List['ScoreComment']],
    ...
    def __getitem__(self, i: int) -> 'ScoreComment':
...
class GetScoreComments(BaseApi):
    ...
    def get_score_comments(
        ...
        return self._get_score_comments_oapg(
