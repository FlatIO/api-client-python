...
TrackSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'score': typing.Union[ScoreSchema, str, ],
        'track': typing.Union[TrackSchema, str, ],
    }
)
...
request_path_track = api_client.PathParameter(
    name="track",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TrackSchema,
    required=True,
...
# body param
SchemaForRequestBodyApplicationJson = ScoreTrackUpdate
...
SchemaFor200ResponseBodyApplicationJson = ScoreTrack
...
class UpdateScoreTrack(BaseApi):
    ...
    def update_score_track(
        ...
        return self._update_score_track_oapg(
            body=body,
