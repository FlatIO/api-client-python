...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ScoreRevision']:
            return ScoreRevision

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ScoreRevision'], typing.List['ScoreRevision']],
    ...
    def __getitem__(self, i: int) -> 'ScoreRevision':
...
class GetScoreRevisions(BaseApi):
    ...
    def get_score_revisions(
        ...
        return self._get_score_revisions_oapg(
