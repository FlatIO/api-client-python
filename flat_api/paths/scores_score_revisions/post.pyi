...
# body param
SchemaForRequestBodyApplicationJson = ScoreRevisionCreation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_score_revision_oapg(
        self,
...
class CreateScoreRevision(BaseApi):
    ...
    def create_score_revision(
        ...
        return self._create_score_revision_oapg(
            body=body,
