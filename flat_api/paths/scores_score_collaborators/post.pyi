...
# body param
SchemaForRequestBodyApplicationJson = ResourceCollaboratorCreation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_score_collaborator_oapg(
        self,
...
class AddScoreCollaborator(BaseApi):
    ...
    def add_score_collaborator(
        ...
        return self._add_score_collaborator_oapg(
            body=body,
