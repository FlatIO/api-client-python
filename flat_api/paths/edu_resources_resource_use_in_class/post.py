...
request_path_resource = api_client.PathParameter(
    name="resource",
...
# body param
SchemaForRequestBodyApplicationJson = EduResourceUseInClass


request_body_edu_resource_use_in_class = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ClassAssignment
...
class BaseApi(api_client.Api):
    @typing.overload
    def _use_edu_resource_in_class_oapg(
        self,
    ...
    def _use_edu_resource_in_class_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_edu_resource_use_in_class.serialize(body, content_type)
...
class UseEduResourceInClass(BaseApi):
    ...
    def use_edu_resource_in_class(
        ...
        return self._use_edu_resource_in_class_oapg(
            body=body,
