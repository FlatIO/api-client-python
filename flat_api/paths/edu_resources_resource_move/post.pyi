...
# body param
SchemaForRequestBodyApplicationJson = EduResourceMove


request_body_edu_resource_move = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _move_edu_resource_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_edu_resource_move.serialize(body, content_type)
...
class MoveEduResource(BaseApi):
    ...
    def move_edu_resource(
        ...
        return self._move_edu_resource_oapg(
            body=body,
