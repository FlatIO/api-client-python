...
# body param
SchemaForRequestBodyApplicationJson = EduResourceCopy


request_body_edu_resource_copy = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _copy_edu_resource_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_edu_resource_copy.serialize(body, content_type)
...
class CopyEduResource(BaseApi):
    ...
    def copy_edu_resource(
        ...
        return self._copy_edu_resource_oapg(
            body=body,
