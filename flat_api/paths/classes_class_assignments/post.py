...
# body param
SchemaForRequestBodyApplicationJson = ClassAssignmentUpdate
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_class_assignment_oapg(
        self,
...
class CreateClassAssignment(BaseApi):
    ...
    def create_class_assignment(
        ...
        return self._create_class_assignment_oapg(
            body=body,
