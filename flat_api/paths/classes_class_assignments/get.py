...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ClassAssignment']:
            return ClassAssignment

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ClassAssignment'], typing.List['ClassAssignment']],
    ...
    def __getitem__(self, i: int) -> 'ClassAssignment':
...
class ListAssignments(BaseApi):
    ...
    def list_assignments(
        ...
        return self._list_assignments_oapg(
