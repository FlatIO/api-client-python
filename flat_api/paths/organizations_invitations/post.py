...
# body param
SchemaForRequestBodyApplicationJson = OrganizationInvitationCreation
...
SchemaFor200ResponseBodyApplicationJson = OrganizationInvitation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_organization_invitation_oapg(
        self,
...
class CreateOrganizationInvitation(BaseApi):
    ...
    def create_organization_invitation(
        ...
        return self._create_organization_invitation_oapg(
            body=body,
