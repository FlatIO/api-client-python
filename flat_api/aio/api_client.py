...
from flat_api.aio.configuration import Configuration
from flat_api.aio.api_response import ApiResponse, T as ApiResponseT
import flat_api.aio.models
from flat_api.aio import rest
from flat_api.aio.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(flat_api.aio.models, klass)
