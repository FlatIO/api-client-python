...
class CollectionApi:
    ...
    @validate_call
    async def add_score_to_collection(
        self,
        collection: Annotated[StrictStr, Field(description="Unique identifier of the collection.  The following collection aliases are supported: - `root`: **Deprecated.** The root collection of the account - `app`: Alias for the current app collection - `trash`: Automatically contains resources that have been deleted ")],
        ...
        :param collection: Unique identifier of the collection.  The following collection aliases are supported: - `root`: **Deprecated.** The root collection of the account - `app`: Alias for the current app collection - `trash`: Automatically contains resources that have been deleted  (required)
        :type collection: str
    ...
    @validate_call
    async def add_score_to_collection_with_http_info(
        self,
        collection: Annotated[StrictStr, Field(description="Unique identifier of the collection.  The following collection aliases are supported: - `root`: **Deprecated.** The root collection of the account - `app`: Alias for the current app collection - `trash`: Automatically contains resources that have been deleted ")],
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def add_score_to_collection_without_preload_content(
        self,
        collection: Annotated[StrictStr, Field(description="Unique identifier of the collection.  The following collection aliases are supported: - `root`: **Deprecated.** The root collection of the account - `app`: Alias for the current app collection - `trash`: Automatically contains resources that have been deleted ")],
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def delete_score_from_collection(
        self,
        collection: Annotated[StrictStr, Field(description="Unique identifier of the collection.  The following collection aliases are supported: - `root`: **Deprecated.** The root collection of the account - `app`: Alias for the current app collection - `trash`: Automatically contains resources that have been deleted ")],
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
    ...
    @validate_call
    async def delete_score_from_collection_with_http_info(
        self,
        collection: Annotated[StrictStr, Field(description="Unique identifier of the collection.  The following collection aliases are supported: - `root`: **Deprecated.** The root collection of the account - `app`: Alias for the current app collection - `trash`: Automatically contains resources that have been deleted ")],
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        event_properties: Annotated[Optional[StrictStr], Field(description="Optional analytics properties merged into the analytics events recorded for this request.  JSON-encoded string representing event properties. Example:  - `?eventProperties={\"context\":\"discover\",\"screenLevel0\":\"home\"}` ")] = None,
    ...
    @validate_call
    async def delete_score_from_collection_without_preload_content(
        self,
        collection: Annotated[StrictStr, Field(description="Unique identifier of the collection.  The following collection aliases are supported: - `root`: **Deprecated.** The root collection of the account - `app`: Alias for the current app collection - `trash`: Automatically contains resources that have been deleted ")],
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        event_properties: Annotated[Optional[StrictStr], Field(description="Optional analytics properties merged into the analytics events recorded for this request.  JSON-encoded string representing event properties. Example:  - `?eventProperties={\"context\":\"discover\",\"screenLevel0\":\"home\"}` ")] = None,
    ...
    @validate_call
    async def edit_collection_with_http_info(
        self,
        collection: Annotated[StrictStr, Field(description="Unique identifier of the collection.  The following collection aliases are supported: - `root`: **Deprecated.** The root collection of the account - `app`: Alias for the current app collection - `trash`: Automatically contains resources that have been deleted  The following virtual collections are supported: - `allScores`: All the scores contained in the user account - `collaborations`: All shared scores by the user or someone else - `likes`: Liked scores ")],
        body: CollectionModification,
        _request_timeout: Union[
    ...
    @validate_call
    async def edit_collection_without_preload_content(
        self,
        collection: Annotated[StrictStr, Field(description="Unique identifier of the collection.  The following collection aliases are supported: - `root`: **Deprecated.** The root collection of the account - `app`: Alias for the current app collection - `trash`: Automatically contains resources that have been deleted  The following virtual collections are supported: - `allScores`: All the scores contained in the user account - `collaborations`: All shared scores by the user or someone else - `likes`: Liked scores ")],
        body: CollectionModification,
        _request_timeout: Union[
    ...
    @validate_call
    async def list_collection_scores(
        self,
        collection: Annotated[StrictStr, Field(description="Unique identifier of the collection.  The following collection aliases are supported: - `root`: **Deprecated.** The root collection of the account - `app`: Alias for the current app collection - `trash`: Automatically contains resources that have been deleted  The following virtual collections are supported: - `allScores`: All the scores contained in the user account - `collaborations`: All shared scores by the user or someone else - `likes`: Liked scores ")],
    ...
    @validate_call
    async def list_collection_scores_with_http_info(
        self,
        collection: Annotated[StrictStr, Field(description="Unique identifier of the collection.  The following collection aliases are supported: - `root`: **Deprecated.** The root collection of the account - `app`: Alias for the current app collection - `trash`: Automatically contains resources that have been deleted  The following virtual collections are supported: - `allScores`: All the scores contained in the user account - `collaborations`: All shared scores by the user or someone else - `likes`: Liked scores ")],
        sort: Annotated[Optional[StrictStr], Field(description="Sort")] = None,
        direction: Annotated[Optional[StrictStr], Field(description="Sort direction")] = None,
    ...
    @validate_call
    async def list_collection_scores_without_preload_content(
        self,
        collection: Annotated[StrictStr, Field(description="Unique identifier of the collection.  The following collection aliases are supported: - `root`: **Deprecated.** The root collection of the account - `app`: Alias for the current app collection - `trash`: Automatically contains resources that have been deleted  The following virtual collections are supported: - `allScores`: All the scores contained in the user account - `collaborations`: All shared scores by the user or someone else - `likes`: Liked scores ")],
        sort: Annotated[Optional[StrictStr], Field(description="Sort")] = None,
        direction: Annotated[Optional[StrictStr], Field(description="Sort direction")] = None,
    ...
    async def list_collections(
        self,
        parent: Annotated[Optional[StrictStr], Field(description="List the collections contained in this `parent` collection.  When set to `user` (default), returns the user's own collections as well as collections shared with the user.  Using `root` or `sharedWithMe` is **deprecated** and will be treated as `user`. ")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort")] = None,
        direction: Annotated[Optional[StrictStr], Field(description="Sort direction")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="This is the maximum number of objects that may be returned")] = None,
        next: Annotated[Optional[StrictStr], Field(description="An opaque string cursor to fetch the next page of data. The paginated API URLs are returned in the `Link` header when requesting the API. These URLs will contain a `next` and `previous` cursor based on the available data. ")] = None,
        ...
        :param parent: List the collections contained in this `parent` collection.  When set to `user` (default), returns the user's own collections as well as collections shared with the user.  Using `root` or `sharedWithMe` is **deprecated** and will be treated as `user`. 
        :type parent: str
        :param sort: Sort
        :type sort: str
        :param direction: Sort direction
    ...
    @validate_call
    async def untrash_collection(
        self,
        collection: Annotated[StrictStr, Field(description="Unique identifier of the collection.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        **DEPRECATED** This method will restore the collection by removing it from the `trash` and add it back to the `root` collection. 
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("POST /collections/{collection}/untrash is deprecated.", DeprecationWarning)
    ...
    @validate_call
    async def untrash_collection_with_http_info(
        self,
        collection: Annotated[StrictStr, Field(description="Unique identifier of the collection.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def untrash_collection_without_preload_content(
        self,
        collection: Annotated[StrictStr, Field(description="Unique identifier of the collection.")],
        _request_timeout: Union[
            None,
