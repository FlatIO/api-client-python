...
class ScoreApi:
    ...
    @validate_call
    async def add_score_collaborator(
        self,
    ...
    @validate_call
    async def add_score_collaborator_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        body: ResourceCollaboratorCreation,
        _request_timeout: Union[
    ...
    @validate_call
    async def add_score_collaborator_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        body: ResourceCollaboratorCreation,
        _request_timeout: Union[
    ...
    async def add_score_track(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ScoreTrackCreationResponse",
            '403': "FlatErrorResponse",
            '404': "FlatErrorResponse",
            'default': "FlatErrorResponse",
        }
    ...
    @validate_call
    async def add_score_track_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        body: ScoreTrackCreation,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ScoreTrackCreationResponse]:
        """Add a new video or audio track to the score
    ...
    @validate_call
    async def add_score_track_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        body: ScoreTrackCreation,
        _request_timeout: Union[
    ...
    @validate_call
    async def create_export_task_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        revision: Annotated[StrictStr, Field(description="Unique identifier of a score revision. You can use `last` to fetch the information related to the last version created. ")],
        format: Annotated[StrictStr, Field(description="The format of the file that will be generated or the target service name where the file will be exported")],
    ...
    @validate_call
    async def create_export_task_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        revision: Annotated[StrictStr, Field(description="Unique identifier of a score revision. You can use `last` to fetch the information related to the last version created. ")],
        format: Annotated[StrictStr, Field(description="The format of the file that will be generated or the target service name where the file will be exported")],
    ...
    @validate_call
    async def create_score_with_http_info(
        self,
        body: ScoreCreation,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def create_score_without_preload_content(
        self,
        body: ScoreCreation,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def create_score_revision_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        body: ScoreRevisionCreation,
        _request_timeout: Union[
    ...
    @validate_call
    async def create_score_revision_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        body: ScoreRevisionCreation,
        _request_timeout: Union[
    ...
    async def delete_score(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        now: Annotated[Optional[StrictBool], Field(description="If `true`, the score deletion will be scheduled as soon as possible")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param score: Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`).  (required)
        :type score: str
        :param now: If `true`, the score deletion will be scheduled as soon as possible
        :type now: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    @validate_call
    async def delete_score_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        now: Annotated[Optional[StrictBool], Field(description="If `true`, the score deletion will be scheduled as soon as possible")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def delete_score_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        now: Annotated[Optional[StrictBool], Field(description="If `true`, the score deletion will be scheduled as soon as possible")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def delete_score_comment(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        comment: Annotated[StrictStr, Field(description="Unique identifier of a sheet music comment ")],
        event_properties: Annotated[Optional[StrictStr], Field(description="Optional analytics properties merged into the analytics events recorded for this request.  JSON-encoded string representing event properties. Example:  - `?eventProperties={\"context\":\"discover\",\"screenLevel0\":\"home\"}` ")] = None,
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :type comment: str
        :param event_properties: Optional analytics properties merged into the analytics events recorded for this request.  JSON-encoded string representing event properties. Example:  - `?eventProperties={\"context\":\"discover\",\"screenLevel0\":\"home\"}` 
        :type event_properties: str
        :param sharing_key: This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. 
        :type sharing_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
    ...
    @validate_call
    async def delete_score_comment_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        comment: Annotated[StrictStr, Field(description="Unique identifier of a sheet music comment ")],
        event_properties: Annotated[Optional[StrictStr], Field(description="Optional analytics properties merged into the analytics events recorded for this request.  JSON-encoded string representing event properties. Example:  - `?eventProperties={\"context\":\"discover\",\"screenLevel0\":\"home\"}` ")] = None,
    ...
    @validate_call
    async def delete_score_comment_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        comment: Annotated[StrictStr, Field(description="Unique identifier of a sheet music comment ")],
        event_properties: Annotated[Optional[StrictStr], Field(description="Optional analytics properties merged into the analytics events recorded for this request.  JSON-encoded string representing event properties. Example:  - `?eventProperties={\"context\":\"discover\",\"screenLevel0\":\"home\"}` ")] = None,
    ...
    def _delete_score_comment_serialize(
        ...
        if event_properties is not None:
            ...
            _query_params.append(('eventProperties', event_properties))
    ...
    @validate_call
    async def delete_score_track_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        track: Annotated[StrictStr, Field(description="Unique identifier of a score audio track ")],
        _request_timeout: Union[
    ...
    @validate_call
    async def delete_score_track_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        track: Annotated[StrictStr, Field(description="Unique identifier of a score audio track ")],
        _request_timeout: Union[
    ...
    @validate_call
    async def edit_score_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        body: ScoreModification,
        _request_timeout: Union[
    ...
    @validate_call
    async def edit_score_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        body: ScoreModification,
        _request_timeout: Union[
    ...
    @validate_call
    async def fork_score_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        body: ScoreFork,
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def fork_score_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        body: ScoreFork,
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def get_group_scores(
        self,
        group: Annotated[StrictStr, Field(description="Unique identifier of a Flat group ")],
        parent: Annotated[Optional[StrictStr], Field(description="Only return the scores forked from the score `parent`")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type group: str
        :param parent: Only return the scores forked from the score `parent`
        :type parent: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    @validate_call
    async def get_group_scores_with_http_info(
        self,
        group: Annotated[StrictStr, Field(description="Unique identifier of a Flat group ")],
        parent: Annotated[Optional[StrictStr], Field(description="Only return the scores forked from the score `parent`")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_group_scores_without_preload_content(
        self,
        group: Annotated[StrictStr, Field(description="Unique identifier of a Flat group ")],
        parent: Annotated[Optional[StrictStr], Field(description="Only return the scores forked from the score `parent`")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_score_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_score_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_score_collaborator(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
    ...
    @validate_call
    async def get_score_collaborator_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        collaborator: Annotated[StrictStr, Field(description="Unique identifier of a **collaborator permission**, or unique identifier of a **User**, or unique identifier of a **Group** ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def get_score_collaborator_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        collaborator: Annotated[StrictStr, Field(description="Unique identifier of a **collaborator permission**, or unique identifier of a **User**, or unique identifier of a **Group** ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def get_score_collaborators(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_score_collaborators_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_score_collaborators_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_score_comments_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        type: Annotated[Optional[StrictStr], Field(description="Filter the comments by type")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort")] = None,
    ...
    @validate_call
    async def get_score_comments_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        type: Annotated[Optional[StrictStr], Field(description="Filter the comments by type")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort")] = None,
    ...
    @validate_call
    async def get_score_revision_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        revision: Annotated[StrictStr, Field(description="Unique identifier of a score revision. You can use `last` to fetch the information related to the last version created. ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def get_score_revision_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        revision: Annotated[StrictStr, Field(description="Unique identifier of a score revision. You can use `last` to fetch the information related to the last version created. ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def get_score_revision_data(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        revision: Annotated[StrictStr, Field(description="Unique identifier of a score revision. You can use `last` to fetch the information related to the last version created. ")],
        format: Annotated[StrictStr, Field(description="The format of the file you will retrieve")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
        parts: Annotated[Optional[StrictStr], Field(description="An optional set of part UUIDs to export. This parameter must be composed of part UUIDs separated by commas. For example \"59df645f-bb1c-f1b4-b573-d2afc4491f94,34ef645f-1aef-f3bc-1564-34cca4492b87\". ")] = None,
        ...
        :param sharing_key: This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. 
        :type sharing_key: str
        :param parts: An optional set of part UUIDs to export. This parameter must be composed of part UUIDs separated by commas. For example \"59df645f-bb1c-f1b4-b573-d2afc4491f94,34ef645f-1aef-f3bc-1564-34cca4492b87\". 
        :type parts: str
    ...
    @validate_call
    async def get_score_revision_data_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        revision: Annotated[StrictStr, Field(description="Unique identifier of a score revision. You can use `last` to fetch the information related to the last version created. ")],
        format: Annotated[StrictStr, Field(description="The format of the file you will retrieve")],
    ...
    @validate_call
    async def get_score_revision_data_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        revision: Annotated[StrictStr, Field(description="Unique identifier of a score revision. You can use `last` to fetch the information related to the last version created. ")],
        format: Annotated[StrictStr, Field(description="The format of the file you will retrieve")],
    ...
    @validate_call
    async def get_score_revisions_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_score_revisions_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_score_submissions(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_score_submissions_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_score_submissions_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_score_track_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        track: Annotated[StrictStr, Field(description="Unique identifier of a score audio track ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def get_score_track_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        track: Annotated[StrictStr, Field(description="Unique identifier of a score audio track ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def get_user_likes_with_http_info(
        self,
        user: Annotated[StrictStr, Field(description="Unique identifier of a Flat user. If you authenticated, you can use `me` to refer to the current user. ")],
        next: Annotated[Optional[StrictStr], Field(description="An opaque string cursor to fetch the next page of data. The paginated API URLs are returned in the `Link` header when requesting the API. These URLs will contain a `next` and `previous` cursor based on the available data. ")] = None,
        previous: Annotated[Optional[StrictStr], Field(description="An opaque string cursor to fetch the previous page of data. The paginated API URLs are returned in the `Link` header when requesting the API. These URLs will contain a `next` and `previous` cursor based on the available data. ")] = None,
    ...
    @validate_call
    async def get_user_likes_without_preload_content(
        self,
        user: Annotated[StrictStr, Field(description="Unique identifier of a Flat user. If you authenticated, you can use `me` to refer to the current user. ")],
        next: Annotated[Optional[StrictStr], Field(description="An opaque string cursor to fetch the next page of data. The paginated API URLs are returned in the `Link` header when requesting the API. These URLs will contain a `next` and `previous` cursor based on the available data. ")] = None,
        previous: Annotated[Optional[StrictStr], Field(description="An opaque string cursor to fetch the previous page of data. The paginated API URLs are returned in the `Link` header when requesting the API. These URLs will contain a `next` and `previous` cursor based on the available data. ")] = None,
    ...
    async def get_user_scores(
        self,
        user: Annotated[StrictStr, Field(description="Unique identifier of a Flat user. If you authenticated, you can use `me` to refer to the current user. ")],
        paginate: Annotated[Optional[StrictBool], Field(description="When set to `true`, the API will return a paginated result. When set to `false` or unset, the API will return all the scores. If this parameter is unset or false, then limit/sort/direction/next/previous will be ignored. ")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort")] = None,
        direction: Annotated[Optional[StrictStr], Field(description="Sort direction")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="This is the maximum number of objects that may be returned")] = None,
        next: Annotated[Optional[StrictStr], Field(description="An opaque string cursor to fetch the next page of data. The paginated API URLs are returned in the `Link` header when requesting the API. These URLs will contain a `next` and `previous` cursor based on the available data. ")] = None,
        ...
        :param user: Unique identifier of a Flat user. If you authenticated, you can use `me` to refer to the current user.  (required)
        :type user: str
        :param paginate: When set to `true`, the API will return a paginated result. When set to `false` or unset, the API will return all the scores. If this parameter is unset or false, then limit/sort/direction/next/previous will be ignored. 
        :type paginate: bool
        :param sort: Sort
        :type sort: str
        :param direction: Sort direction
    ...
    @validate_call
    async def get_user_scores_with_http_info(
        self,
        user: Annotated[StrictStr, Field(description="Unique identifier of a Flat user. If you authenticated, you can use `me` to refer to the current user. ")],
        paginate: Annotated[Optional[StrictBool], Field(description="When set to `true`, the API will return a paginated result. When set to `false` or unset, the API will return all the scores. If this parameter is unset or false, then limit/sort/direction/next/previous will be ignored. ")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort")] = None,
    ...
    @validate_call
    async def get_user_scores_without_preload_content(
        self,
        user: Annotated[StrictStr, Field(description="Unique identifier of a Flat user. If you authenticated, you can use `me` to refer to the current user. ")],
        paginate: Annotated[Optional[StrictBool], Field(description="When set to `true`, the API will return a paginated result. When set to `false` or unset, the API will return all the scores. If this parameter is unset or false, then limit/sort/direction/next/previous will be ignored. ")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort")] = None,
    ...
    @validate_call
    async def list_score_tracks(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
        assignment: Annotated[Optional[StrictStr], Field(description="Only return the tracks related to this assignment ")] = None,
        list_auto_track: Annotated[Optional[StrictBool], Field(description="If `true`, and when available, also return the latest MP3 export automatically generated by Flat as an additional track ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param sharing_key: This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. 
        :type sharing_key: str
        :param assignment: Only return the tracks related to this assignment 
        :type assignment: str
        :param list_auto_track: If `true`, and when available, also return the latest MP3 export automatically generated by Flat as an additional track 
    ...
    @validate_call
    async def list_score_tracks_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
        assignment: Annotated[Optional[StrictStr], Field(description="Only return the tracks related to this assignment ")] = None,
    ...
    @validate_call
    async def list_score_tracks_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
        assignment: Annotated[Optional[StrictStr], Field(description="Only return the tracks related to this assignment ")] = None,
    ...
    @validate_call
    async def mark_score_comment_resolved(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        comment: Annotated[StrictStr, Field(description="Unique identifier of a sheet music comment ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def mark_score_comment_resolved_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        comment: Annotated[StrictStr, Field(description="Unique identifier of a sheet music comment ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def mark_score_comment_resolved_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        comment: Annotated[StrictStr, Field(description="Unique identifier of a sheet music comment ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def mark_score_comment_unresolved(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        comment: Annotated[StrictStr, Field(description="Unique identifier of a sheet music comment ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def mark_score_comment_unresolved_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        comment: Annotated[StrictStr, Field(description="Unique identifier of a sheet music comment ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def mark_score_comment_unresolved_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        comment: Annotated[StrictStr, Field(description="Unique identifier of a sheet music comment ")],
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def post_score_comment_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        body: ScoreCommentCreation,
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def post_score_comment_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        body: ScoreCommentCreation,
        sharing_key: Annotated[Optional[StrictStr], Field(description="This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. ")] = None,
    ...
    @validate_call
    async def remove_score_collaborator(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        collaborator: Annotated[StrictStr, Field(description="Unique identifier of a **collaborator permission**, or unique identifier of a **User**, or unique identifier of a **Group** ")],
        event_properties: Annotated[Optional[StrictStr], Field(description="Optional analytics properties merged into the analytics events recorded for this request.  JSON-encoded string representing event properties. Example:  - `?eventProperties={\"context\":\"discover\",\"screenLevel0\":\"home\"}` ")] = None,
    ...
    @validate_call
    async def remove_score_collaborator_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        collaborator: Annotated[StrictStr, Field(description="Unique identifier of a **collaborator permission**, or unique identifier of a **User**, or unique identifier of a **Group** ")],
        event_properties: Annotated[Optional[StrictStr], Field(description="Optional analytics properties merged into the analytics events recorded for this request.  JSON-encoded string representing event properties. Example:  - `?eventProperties={\"context\":\"discover\",\"screenLevel0\":\"home\"}` ")] = None,
    ...
    @validate_call
    async def remove_score_collaborator_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        collaborator: Annotated[StrictStr, Field(description="Unique identifier of a **collaborator permission**, or unique identifier of a **User**, or unique identifier of a **Group** ")],
        event_properties: Annotated[Optional[StrictStr], Field(description="Optional analytics properties merged into the analytics events recorded for this request.  JSON-encoded string representing event properties. Example:  - `?eventProperties={\"context\":\"discover\",\"screenLevel0\":\"home\"}` ")] = None,
    ...
    @validate_call
    async def untrash_score_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def untrash_score_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def update_score_comment(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        comment: Annotated[StrictStr, Field(description="Unique identifier of a sheet music comment ")],
    ...
    @validate_call
    async def update_score_comment_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        comment: Annotated[StrictStr, Field(description="Unique identifier of a sheet music comment ")],
        body: ScoreCommentUpdate,
    ...
    @validate_call
    async def update_score_comment_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        comment: Annotated[StrictStr, Field(description="Unique identifier of a sheet music comment ")],
        body: ScoreCommentUpdate,
    ...
    @validate_call
    async def update_score_track_with_http_info(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        track: Annotated[StrictStr, Field(description="Unique identifier of a score audio track ")],
        body: ScoreTrackUpdate,
    ...
    @validate_call
    async def update_score_track_without_preload_content(
        self,
        score: Annotated[StrictStr, Field(description="Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`). ")],
        track: Annotated[StrictStr, Field(description="Unique identifier of a score audio track ")],
        body: ScoreTrackUpdate,
