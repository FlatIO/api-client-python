...
class EduResourcesApi:
    ...
    async def list_edu_resources(
        ...
        without_subfolders_resources: Annotated[Optional[StrictBool], Field(description="For the `parent` = `organization`, do not include resources from subfolders. Resources from subfolders are included by default; set this to `true` to list only the direct children, for example in a picker. ")] = None,
        ...
        :type parent: str
        :param without_subfolders_resources: For the `parent` = `organization`, do not include resources from subfolders. Resources from subfolders are included by default; set this to `true` to list only the direct children, for example in a picker. 
