...
class EduResourcesApi:
    ...
    @validate_call
    async def copy_edu_resource_with_http_info(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        edu_resource_copy: EduResourceCopy,
        _request_timeout: Union[
    ...
    @validate_call
    async def copy_edu_resource_without_preload_content(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        edu_resource_copy: EduResourceCopy,
        _request_timeout: Union[
    ...
    @validate_call
    async def copy_edu_resource_to_demo_class(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def copy_edu_resource_to_demo_class_with_http_info(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def copy_edu_resource_to_demo_class_without_preload_content(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def create_edu_resource_with_http_info(
        self,
        edu_resource_creation: EduResourceCreation,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def create_edu_resource_without_preload_content(
        self,
        edu_resource_creation: EduResourceCreation,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def create_edu_resource_lti_link(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def create_edu_resource_lti_link_with_http_info(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def create_edu_resource_lti_link_without_preload_content(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def delete_edu_resource_with_http_info(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def delete_edu_resource_without_preload_content(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_edu_resource_with_http_info(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_edu_resource_without_preload_content(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def list_edu_libraries_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def list_edu_libraries_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def list_edu_resources(
        self,
        parent: Annotated[Optional[StrictStr], Field(description="List the resources contained in this `parent` library or folder.  Accepts a folder identifier, or the identifier of one of the libraries returned by [`listEduLibraries`](#tag/EduResources/operation/listEduLibraries). Which libraries are available depends on the account, so use the `id` values that endpoint returns rather than hardcoding this list:  * `root`: the user's own resources * `organization`: resources shared with the organization ")] = None,
        without_subfolders_resources: Annotated[Optional[StrictBool], Field(description="For the `parent` = `organization`, do not include resources from subfolders. By default in the Resource Library UI, we include resources from subfolders, but for example in a picker like LTI, we don't want to include them. ")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Filter the returned resources by type ")] = None,
        subjects: Annotated[Optional[List[TeachingTheme]], Field(description="Filter the returned resources by subjects ")] = None,
        assignment_types: Annotated[Optional[List[AssignmentType]], Field(description="Filter the returned resources by assignment types ")] = None,
        grades: Annotated[Optional[List[Grade]], Field(description="Filter the returned resources by grades ")] = None,
        ...
        :type parent: str
        :param without_subfolders_resources: For the `parent` = `organization`, do not include resources from subfolders. By default in the Resource Library UI, we include resources from subfolders, but for example in a picker like LTI, we don't want to include them. 
        :type without_subfolders_resources: bool
        :param type: Filter the returned resources by type 
        :type type: str
        :param subjects: Filter the returned resources by subjects 
        :type subjects: List[TeachingTheme]
        :param assignment_types: Filter the returned resources by assignment types 
        :type assignment_types: List[AssignmentType]
        :param grades: Filter the returned resources by grades 
        ...
        _param = self._list_edu_resources_serialize(
            parent=parent,
            without_subfolders_resources=without_subfolders_resources,
            type=type,
            subjects=subjects,
    ...
    @validate_call
    async def list_edu_resources_with_http_info(
        self,
        parent: Annotated[Optional[StrictStr], Field(description="List the resources contained in this `parent` library or folder.  Accepts a folder identifier, or the identifier of one of the libraries returned by [`listEduLibraries`](#tag/EduResources/operation/listEduLibraries). Which libraries are available depends on the account, so use the `id` values that endpoint returns rather than hardcoding this list:  * `root`: the user's own resources * `organization`: resources shared with the organization ")] = None,
        without_subfolders_resources: Annotated[Optional[StrictBool], Field(description="For the `parent` = `organization`, do not include resources from subfolders. By default in the Resource Library UI, we include resources from subfolders, but for example in a picker like LTI, we don't want to include them. ")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Filter the returned resources by type ")] = None,
    ...
    @validate_call
    async def list_edu_resources_without_preload_content(
        self,
        parent: Annotated[Optional[StrictStr], Field(description="List the resources contained in this `parent` library or folder.  Accepts a folder identifier, or the identifier of one of the libraries returned by [`listEduLibraries`](#tag/EduResources/operation/listEduLibraries). Which libraries are available depends on the account, so use the `id` values that endpoint returns rather than hardcoding this list:  * `root`: the user's own resources * `organization`: resources shared with the organization ")] = None,
        without_subfolders_resources: Annotated[Optional[StrictBool], Field(description="For the `parent` = `organization`, do not include resources from subfolders. By default in the Resource Library UI, we include resources from subfolders, but for example in a picker like LTI, we don't want to include them. ")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Filter the returned resources by type ")] = None,
    ...
    def _list_edu_resources_serialize(
        ...
        if without_subfolders_resources is not None:
            
            _query_params.append(('withoutSubfoldersResources', without_subfolders_resources))
        ...
        if assignment_types is not None:
            ...
            _query_params.append(('assignmentTypes', assignment_types))
    ...
    @validate_call
    async def move_edu_resource_with_http_info(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        edu_resource_move: EduResourceMove,
        _request_timeout: Union[
    ...
    @validate_call
    async def move_edu_resource_without_preload_content(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        edu_resource_move: EduResourceMove,
        _request_timeout: Union[
    ...
    @validate_call
    async def update_edu_resource_with_http_info(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        edu_resource_update: EduResourceUpdate,
        _request_timeout: Union[
    ...
    @validate_call
    async def update_edu_resource_without_preload_content(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        edu_resource_update: EduResourceUpdate,
        _request_timeout: Union[
    ...
    @validate_call
    async def update_edu_resource_assignment(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
    ...
    @validate_call
    async def update_edu_resource_assignment_with_http_info(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        assignment_update: AssignmentUpdate,
        _request_timeout: Union[
    ...
    @validate_call
    async def update_edu_resource_assignment_without_preload_content(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        assignment_update: AssignmentUpdate,
        _request_timeout: Union[
    ...
    @validate_call
    async def use_edu_resource_in_class(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
    ...
    @validate_call
    async def use_edu_resource_in_class_with_http_info(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        edu_resource_use_in_class: EduResourceUseInClass,
        _request_timeout: Union[
    ...
    @validate_call
    async def use_edu_resource_in_class_without_preload_content(
        self,
        resource: Annotated[StrictStr, Field(description="Unique identifier of the resource")],
        edu_resource_use_in_class: EduResourceUseInClass,
        _request_timeout: Union[
