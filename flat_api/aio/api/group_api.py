...
class GroupApi:
    ...
    @validate_call
    async def add_group_user_with_http_info(
        self,
        group: Annotated[StrictStr, Field(description="Unique identifier of a Flat group ")],
        add_group_user_request: AddGroupUserRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def add_group_user_without_preload_content(
        self,
        group: Annotated[StrictStr, Field(description="Unique identifier of a Flat group ")],
        add_group_user_request: AddGroupUserRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_group_details_with_http_info(
        self,
        group: Annotated[StrictStr, Field(description="Unique identifier of a Flat group ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_group_details_without_preload_content(
        self,
        group: Annotated[StrictStr, Field(description="Unique identifier of a Flat group ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def remove_group_user_with_http_info(
        self,
        group: Annotated[StrictStr, Field(description="Unique identifier of a Flat group ")],
        user: Annotated[StrictStr, Field(description="User ID")],
        _request_timeout: Union[
    ...
    @validate_call
    async def remove_group_user_without_preload_content(
        self,
        group: Annotated[StrictStr, Field(description="Unique identifier of a Flat group ")],
        user: Annotated[StrictStr, Field(description="User ID")],
        _request_timeout: Union[
    ...
    @validate_call
    async def rename_group_with_http_info(
        self,
        group: Annotated[StrictStr, Field(description="Unique identifier of a Flat group ")],
        rename_group_request: RenameGroupRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def rename_group_without_preload_content(
        self,
        group: Annotated[StrictStr, Field(description="Unique identifier of a Flat group ")],
        rename_group_request: RenameGroupRequest,
        _request_timeout: Union[
