...
class UserDetailsAdminAllOfLicense(BaseModel):
    """
    ...
    source: Optional[LicenseSources] = LicenseSources.ORDER
    mode: Optional[LicenseMode] = None
    active: Optional[StrictBool] = Field(default=None, description="Whether the license is currently active")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "source": obj.get("source") if obj.get("source") is not None else LicenseSources.ORDER,
            "mode": obj.get("mode"),
