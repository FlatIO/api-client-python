...
class ScoreTrackCreationResponse(BaseModel):
    """
    Response for track creation including optional upload information
    """ # noqa: E501
    track: ScoreTrack
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["track"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "track": ScoreTrack.from_dict(obj["track"]) if obj.get("track") is not None else None
        })
