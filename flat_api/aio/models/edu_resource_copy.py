...
class EduResourceCopy(BaseModel):
    ...
    """ # noqa: E501
    destination: StrictStr = Field(description="Unique identifier of the destination folder for the copy. This can also be `root` to copy the resource at the root of the user resource library. ")
