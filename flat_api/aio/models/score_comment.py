...
class ScoreComment(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="The comment unique identifier")
    type: StrictStr = Field(description="The type of the comment")
    user: StrictStr = Field(description="The author unique identifier")
    score: StrictStr = Field(description="The unique identifier of the score where the comment was posted")
    revision: Optional[StrictStr] = Field(default=None, description="The unique identifier of the revision where the comment was posted")
    ...
    var_date: datetime = Field(description="The date when the comment was posted", alias="date")
    ...
    comment: StrictStr = Field(description="The comment text that can include mentions using the following format: `@[id:username]`. ")
    raw_comment: StrictStr = Field(description="A raw version of the comment, that can be displayed without parsing the mentions. ", alias="rawComment")
    ...
    resolved_by: Optional[StrictStr] = Field(default=None, description="If the comment is marked as resolved, this will contain the unique identifier of the User who marked this comment as resolved ", alias="resolvedBy")
