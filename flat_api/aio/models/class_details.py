...
class ClassDetails(BaseModel):
    ...
    state: ClassState
    name: StrictStr = Field(description="The name of the class")
    section: Optional[StrictStr] = Field(default=None, description="The section of the class")
    description: Optional[StrictStr] = Field(default=None, description="An optional description for this class")
    ...
    creation_date: datetime = Field(description="The date when the class was created", alias="creationDate")
    modification_date: Optional[datetime] = Field(default=None, description="The date when the class was last modified", alias="modificationDate")
    ...
    theme: Optional[StrictStr] = Field(default=None, description="The theme identifier used in the Flat user interface")
    ...
    __properties: ClassVar[List[str]] = ["id", "state", "name", "section", "description", "organization", "owner", "creationDate", "modificationDate", "enrollmentCode", "theme", "assignmentsCount", "studentsGroup", "teachersGroup", "issues", "googleClassroom", "googleDrive", "microsoftGraph", "lti", "canvas", "mfc", "clever", "level", "skillsFocused", "size"]
