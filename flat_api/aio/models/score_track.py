...
class ScoreTrack(BaseModel):
    ...
    score: Optional[StrictStr] = Field(default=None, description="The unique identifier of the score. Absent for Free Record performance submissions, which are recorded without an attached score. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "purpose": obj.get("purpose") if obj.get("purpose") is not None else ScoreTrackPurpose.COMMON,
            "url": obj.get("url"),
