...
class ScoreRevision(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier of the revision.")
    user: Optional[StrictStr] = Field(default=None, description="The user identifier who created the revision")
    score: StrictStr = Field(description="The score identifier")
    collaborators: Optional[List[StrictStr]] = None
    var_date: datetime = Field(description="The date when this revision was created", alias="date")
    ...
    __properties: ClassVar[List[str]] = ["id", "user", "score", "collaborators", "date", "event", "description", "autosave", "statistics"]
