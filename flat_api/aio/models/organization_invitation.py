...
class OrganizationInvitation(BaseModel):
    ...
    organization: StrictStr = Field(description="The unique identifier of the Organization this invitation belongs to")
    ...
    html_url: Optional[StrictStr] = Field(default=None, description="URL to join the organization using this invitation", alias="htmlUrl")
    ...
    __properties: ClassVar[List[str]] = ["id", "creationDate", "organization", "organizationRole", "customCode", "email", "invitedBy", "htmlUrl", "allowMultipleUse", "usedBy"]
