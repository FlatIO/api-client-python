...
class ScoreCreationBuilderData(BaseModel):
    ...
    privacy: Optional[ScorePrivacy] = ScorePrivacy.PRIVATE
    collection: Optional[StrictStr] = Field(default=None, description="Unique identifier of a collection where the score will be created. If no collection identifier is provided, the score will not be added to any collection and will only be visible in the `allScores` virtual collection. ")
    google_drive_folder: Optional[StrictStr] = Field(default=None, description="If the user uses Google Drive and this property is specified, the file will be created in this directory. The user creating the file must have write access to this directory. ", alias="googleDriveFolder")
    builder_data: ScoreCreationBuilderDataAllOfBuilderData = Field(alias="builderData")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["title", "privacy", "collection", "googleDriveFolder", "builderData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "builderData": ScoreCreationBuilderDataAllOfBuilderData.from_dict(obj["builderData"]) if obj.get("builderData") is not None else None
        })
