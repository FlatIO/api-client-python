...
class ResourceCollaboratorCreation(BaseModel):
    ...
    acl_admin: Optional[StrictBool] = Field(default=False, description="`True` if the related user can manage the current document, i.e. changing the document permissions and deleting the document ", alias="aclAdmin")
