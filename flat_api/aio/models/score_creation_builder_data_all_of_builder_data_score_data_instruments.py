...
class ScoreCreationBuilderDataAllOfBuilderDataScoreDataInstruments(BaseModel):
    """
    ScoreCreationBuilderDataAllOfBuilderDataScoreDataInstruments
    """ # noqa: E501
    group: StrictStr = Field(description="The identifier of the instrument group (e.g. `keyboards`, `brass`)")
    ...
    has_quarter_tone: Optional[StrictBool] = Field(default=None, description="True if the part can use quarter tones (prevents the part from having a TAB staff or chord grid)", alias="hasQuarterTone")
