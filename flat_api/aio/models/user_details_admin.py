...
class UserDetailsAdmin(BaseModel):
    ...
    license: Optional[UserDetailsAdminAllOfLicense] = None
    ...
    is_edu_testing_student: Optional[StrictBool] = Field(default=None, description="Indicates if the user account is marked as a testing student account. Testing students are typically excluded from certain educational integrations and workflows. This field helps API clients distinguish between regular students and testing accounts. ", alias="isEduTestingStudent")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "product", "username", "printableName", "firstname", "lastname", "name", "picture", "badges", "organization", "organizationRole", "classRole", "htmlUrl", "email", "lastActivityDate", "license", "groups", "isEduTestingStudent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "license": UserDetailsAdminAllOfLicense.from_dict(obj["license"]) if obj.get("license") is not None else None,
            "groups": obj.get("groups"),
            "isEduTestingStudent": obj.get("isEduTestingStudent")
        })
