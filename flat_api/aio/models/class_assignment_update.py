...
class ClassAssignmentUpdate(BaseModel):
    ...
    max_points: Optional[Union[Annotated[float, Field(le=10000, strict=True, ge=0)], Annotated[int, Field(le=10000, strict=True, ge=0)]]] = Field(default=None, description="If set, the grading will be enabled for the assignment with this value as the maximum of points ", alias="maxPoints")
    ...
    due_date: Optional[datetime] = Field(default=None, description="The due date of this assignment, late submissions will be marked as past due. If not set, the assignment won't have a due date. ", alias="dueDate")
    ...
    google_classroom: Optional[ClassAssignmentUpdateAllOfGoogleClassroom] = Field(default=None, alias="googleClassroom")
    microsoft_graph: Optional[ClassAssignmentUpdateAllOfMicrosoftGraph] = Field(default=None, alias="microsoftGraph")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if class_group_ids (nullable) is None
        # and model_fields_set contains the field
        if self.class_group_ids is None and "class_group_ids" in self.model_fields_set:
            _dict['classGroupIds'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "googleClassroom": ClassAssignmentUpdateAllOfGoogleClassroom.from_dict(obj["googleClassroom"]) if obj.get("googleClassroom") is not None else None,
            "microsoftGraph": ClassAssignmentUpdateAllOfMicrosoftGraph.from_dict(obj["microsoftGraph"]) if obj.get("microsoftGraph") is not None else None,
            "assigneeMode": obj.get("assigneeMode"),
            "assignedStudents": obj.get("assignedStudents"),
            "classGroupIds": obj.get("classGroupIds")
        })
