...
class ClassDetailsLti(BaseModel):
    ...
    has_nrps_service: Optional[StrictBool] = Field(default=None, description="If true, the class has been synchronized with the LTI 1.3 NRPS 2.0 service", alias="hasNrpsService")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["contextId", "contextTitle", "contextLabel", "hasNrpsService"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hasNrpsService": obj.get("hasNrpsService")
        })
