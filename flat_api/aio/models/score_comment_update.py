...
class ScoreCommentUpdate(BaseModel):
    ...
    Update of a comment
    """ # noqa: E501
    revision: Optional[StrictStr] = Field(default=None, description="The unique identifier of the revision of the score where the comment was added. If this property is unspecified or contains \"last\", the API will automatically take the last revision created. ")
    comment: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=10000)]] = Field(default=None, description="The comment text that can include mentions using the following format: `@[id:username]`. ")
