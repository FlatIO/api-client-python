...
class OmrPendingStep(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["step", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "step": obj.get("step"),
            "data": OmrDetailsStepData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
