...
class OmrLocaleDetails(BaseModel):
    """
    An OCR-selectable locale with its English name.
    """ # noqa: E501
    code: StrictStr = Field(description="BCP 47 locale code. Always one of the codes listed in `locales`.", json_schema_extra={"examples": ["vi"]})
    name: StrictStr = Field(description="English name of the language, for display in a picker.", json_schema_extra={"examples": ["Vietnamese"]})
