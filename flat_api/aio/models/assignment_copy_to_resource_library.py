...
class AssignmentCopyToResourceLibrary(BaseModel):
    """
    Copy the assignment to the EDU Resource Library
    """ # noqa: E501
    library_parent: StrictStr = Field(description="Identifier of the parent resource where the new one will be created, e.g. a folder id or `root`", alias="libraryParent")
    ...
    __properties: ClassVar[List[str]] = ["libraryParent", "verifyIfNotAlreadyInResourceLibrary"]
