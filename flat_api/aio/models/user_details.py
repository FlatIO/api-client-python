...
class UserDetails(BaseModel):
    ...
    picture: StrictStr = Field(description="The URL of the picture to display")
    ...
    followers_count: Optional[StrictInt] = Field(default=None, description="Number of followers the user has", alias="followersCount")
    following_count: Optional[StrictInt] = Field(default=None, description="Number of people the user follows", alias="followingCount")
    owned_public_scores_count: Optional[StrictInt] = Field(default=None, description="Number of public scores the user owns", alias="ownedPublicScoresCount")
    all_public_scores_count: Optional[StrictInt] = Field(default=None, description="Total number of public scores the user participates in (owned + joined)", alias="allPublicScoresCount")
    likes_count: Optional[StrictInt] = Field(default=None, description="Number of likes on the user published scores", alias="likesCount")
    plays_count: Optional[StrictInt] = Field(default=None, description="Number of plays on the user published scores", alias="playsCount")
    cover_picture: Optional[StrictStr] = Field(default=None, description="Cover picture (background) for the profile", alias="coverPicture")
    ...
    is_email_verified: Optional[StrictBool] = Field(default=None, description="Whether the user's email address has been verified", alias="isEmailVerified")
    azure_details: Optional[UserAzureDetails] = Field(default=None, alias="azureDetails")
    private_profile: Optional[StrictBool] = Field(default=None, description="Whether this user profile is private (individual accounts only)", alias="privateProfile")
    locale: Optional[StrictStr] = Field(default='en', description="The user language. Input values will be automatically normalized to a supported locale code. Unknown locales will default to `en`.  Current supported locales include: `da`, `de`, `en`, `en-GB`, `es`, `fi`, `fil`, `fr`, `fr-CA`, `hi`, `id`, `it`, `ja`, `ja-HIRA`, `ko`, `ms`, `nb`, `nl`, `pl`, `pt`, `pt-BR`, `ro`, `ru`, `sv`, `tr`, `zh-Hans`, `zh-HK`, `zh-TW` ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allPublicScoresCount": obj.get("allPublicScoresCount"),
            "likesCount": obj.get("likesCount"),
            "playsCount": obj.get("playsCount"),
