...
class EduResourceCapabilities(BaseModel):
    ...
    can_change_privacy: Optional[StrictBool] = Field(default=None, description="Whether the current user can change the privacy of this resource (e.g. to share as `organizationPublic` or unshare it with `private`) ", alias="canChangePrivacy")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["canEdit", "canAddResources", "canAddFolders", "canChangePrivacy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "canChangePrivacy": obj.get("canChangePrivacy")
        })
