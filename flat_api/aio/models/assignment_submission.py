...
class AssignmentSubmission(BaseModel):
    ...
    draft_grade: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Optional grade. If unset, no grade was set. This value is only visible to the teacher, and is copied to `grade` once the teacher returns the submission", alias="draftGrade")
    ...
    playback: List[AssignmentSubmissionPlayback]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        _items = []
        if self.playback:
            for _item_playback in self.playback:
                if _item_playback:
                    _items.append(_item_playback.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "playback": [AssignmentSubmissionPlayback.from_dict(_item) for _item in obj["playback"]] if obj.get("playback") is not None else None,
