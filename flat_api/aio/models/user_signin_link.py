...
class UserSigninLink(BaseModel):
    ...
    token: Optional[StrictStr] = Field(default=None, description="Raw sign-in token, can be used to build custom URLs (e.g. deep links)")
    expiration_date: Optional[datetime] = Field(default=None, description="Date when the link expires", alias="expirationDate")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["url", "token", "expirationDate"]
