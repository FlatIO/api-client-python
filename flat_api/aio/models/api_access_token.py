...
class ApiAccessToken(BaseModel):
    ...
    issued_date: Optional[datetime] = Field(default=None, description="The date when this token was issued ", alias="issuedDate")
    expiration_date: Optional[datetime] = Field(default=None, description="The date when this token will expire ", alias="expirationDate")
