...
class AssignmentCapabilities(BaseModel):
    ...
    can_publish_in_class_error: Optional[AssignmentCapabilitiesCanPublishInClassError] = Field(default=None, alias="canPublishInClassError")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "canPublishInClassError": AssignmentCapabilitiesCanPublishInClassError.from_dict(obj["canPublishInClassError"]) if obj.get("canPublishInClassError") is not None else None,
