...
class MediaAttachment(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="The resolved type of the attachment: * `rich`, `photo`, `video` are automatically resolved as `link` * A `flat` attachment is a score document where the unique identifier will be specified in the `score` property. Its sharing mode will be provided in the `sharingMode` property. ")
    score: Optional[StrictStr] = Field(default=None, description="A unique Flat score identifier")
    revision: Optional[StrictStr] = Field(default=None, description="A unique revision identifier of a score")
    worksheet: Optional[StrictStr] = Field(default=None, description="A unique worksheet identifier")
    ...
    thumbnail_height: Optional[StrictInt] = Field(default=None, description="If the `thumbnailUrl` is available, the height of the thumbnail ", alias="thumbnailHeight")
    ...
    mime_type: Optional[StrictStr] = Field(default=None, description="The MIME type of the file", alias="mimeType")
