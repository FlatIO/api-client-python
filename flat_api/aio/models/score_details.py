...
class ScoreDetails(BaseModel):
    ...
    duration_time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="In seconds, an approximate duration of the score", alias="durationTime")
    ...
    instruments: List[StrictStr] = Field(description="An array of the instrument identifiers used in the last version of the score. This is mainly used to display a list of the instruments in Flat's UI or instruments icons. The format of the strings is `{instrument-group}.{instrument-id}`. ")
    ...
    samples: List[StrictStr] = Field(description="An array of the audio sample identifiers used by the different score parts. The format of the strings is `{instrument-group}.{sample-id}`. ")
    ...
    collections: Optional[List[StrictStr]] = Field(default=None, description="The list of parent collections this score is included in. Please note that you might not have access to all of them.")
