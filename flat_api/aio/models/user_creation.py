...
class UserCreation(BaseModel):
    ...
    locale: Optional[StrictStr] = Field(default='en', description="User language. Input values will be automatically normalized to a supported locale code.")
    ...
    def role_validate_enum(cls, value):
        ...
        if value not in set(['user', 'teacher', 'admin', 'accountAdmin']):
            raise ValueError("must be one of enum values ('user', 'teacher', 'admin', 'accountAdmin')")
        return value
