...
class LtiConfigurationCreate1p3DynamicPlatformInfo(BaseModel):
    """
    Optional platform information for dynamic registration
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Platform display name")
    url: Optional[StrictStr] = Field(default=None, description="Optional platform homepage or admin URL for reference")
