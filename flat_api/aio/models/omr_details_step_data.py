...
class OmrDetailsStepData(BaseModel):
    """
    ...
    """ # noqa: E501
    step: StrictStr = Field(description="Discriminator for `OmrPendingStep.data`; always `details` for this payload.")
    title: Optional[StrictStr] = Field(default=None, description="OCR-detected work title.")
    instruments: List[OmrDetectedInstrument]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["step", "title", "instruments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "step": obj.get("step"),
            "title": obj.get("title"),
            "instruments": [OmrDetectedInstrument.from_dict(_item) for _item in obj["instruments"]] if obj.get("instruments") is not None else None
        })
