...
class LtiCredentials(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of this pair of credentials")
    name: Optional[StrictStr] = Field(default=None, description="Name of the pair of credentials")
    ...
    creation_date: Optional[datetime] = Field(default=None, description="The creation date of these credentials", alias="creationDate")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "lms", "organization", "creator", "creationDate", "lastUsage", "consumerKey", "consumerSecret", "enableEmailMatching"]
