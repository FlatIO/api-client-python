...
class ClassDetailsIssuesSyncInner(BaseModel):
    ...
    def reason_validate_enum(cls, value):
        ...
        if value not in set(['otherOrgnanization', 'productMigration', 'disabledAccount']):
            raise ValueError("must be one of enum values ('otherOrgnanization', 'productMigration', 'disabledAccount')")
        return value
