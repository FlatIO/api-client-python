...
class AssignmentSubmissionUpdate(BaseModel):
    ...
    var_return: Optional[StrictBool] = Field(default=None, description="If `true`, the submission will be returned to the student (teachers only)", alias="return")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["attachments", "playback", "submit", "draftGrade", "grade", "exercisesIds", "return"]
