...
class ScoreFork(BaseModel):
    ...
    """ # noqa: E501
    collection: Optional[StrictStr] = Field(default=None, description="Unique identifier of a collection where the score will be copied.  If no collection identifier is provided, a virtual collection is used, or `null` is provided, the score won't be added to any collection and will only be visible in the `allScores` virtual collection. ")
