...
class ScoreSource(BaseModel):
    ...
    ScoreSource
    """ # noqa: E501
    google_drive: Optional[StrictStr] = Field(default=None, description="If the score is a file on Google Drive, this property must contain its identifier. To use this method, the Drive file must be public or the Flat Drive App must have access to the file. ", alias="googleDrive")
