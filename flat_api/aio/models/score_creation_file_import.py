...
class ScoreCreationFileImport(BaseModel):
    """
    ...
    supports_tasks: Optional[StrictBool] = Field(default=None, description="Set this to `true` if the client supports asynchronous task flows. When importing a score that requires OMR processing (a PDF or a page image), the API will return a 202 Accepted response along with a task reference. The client can then check the task status using the endpoint `GET /v2/tasks/{task}`. ", alias="supportsTasks")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["title", "privacy", "collection", "googleDriveFolder", "filename", "data", "dataEncoding", "supportsTasks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "supportsTasks": obj.get("supportsTasks")
        })
