...
class AssignmentSubmissionPlayback(BaseModel):
    """
    Playback used by a student for an assignment submission.
    """ # noqa: E501
    score: StrictStr = Field(description="The score unique identifier")
    nb_play_attempt: Union[StrictFloat, StrictInt] = Field(description="Number of times the score was played", alias="nbPlayAttempt")
