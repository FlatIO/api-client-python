...
class ScoreCommentsCounts(BaseModel):
    ...
    yearly: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The yearly unique number of comments added to the score")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["total", "unique", "weekly", "monthly", "yearly"]
