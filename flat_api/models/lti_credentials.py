...
class LtiCredentials(object):
    ...
    def __init__(self, id=None, name=None, lms=None, organization=None, creator=None, creation_date=None, last_usage=None, consumer_key=None, consumer_secret=None, local_vars_configuration=None):  # noqa: E501
