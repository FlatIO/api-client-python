...
class AssignmentCopyToClass(BaseModel):
    """
    ...
    assignment: Optional[StrictStr] = Field(default=None, description="An optional destination assignment where the original assignment will be copied. Must be a draft.")
    ...
    __properties: ClassVar[List[str]] = ["classroom", "assignment", "scheduledDate"]
