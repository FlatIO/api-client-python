...
class OrganizationInvitation(object):
    ...
    def __init__(self, id=None, organization=None, organization_role=None, custom_code=None, email=None, invited_by=None, used_by=None):
        """
        OrganizationInvitation - a model defined in Swagger
        """
