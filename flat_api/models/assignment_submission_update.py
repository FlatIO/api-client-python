...
class AssignmentSubmissionUpdate(object):
    ...
    def __init__(self, attachments=None, submit=None, draft_grade=None, grade=None, exercises_ids=None, _return=None, comments=None, local_vars_configuration=None):  # noqa: E501
    ...
    def draft_grade(self, draft_grade):
        ...
        if (self.local_vars_configuration.client_side_validation and
                draft_grade is not None and draft_grade > 100):  # noqa: E501
            raise ValueError("Invalid value for `draft_grade`, must be a value less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                draft_grade is not None and draft_grade < 0):  # noqa: E501
