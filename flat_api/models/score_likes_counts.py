...
class ScoreLikesCounts(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, total=None, weekly=None, monthly=None):
        """
        ScoreLikesCounts - a model defined in Swagger
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ScoreLikesCounts):
            return False
