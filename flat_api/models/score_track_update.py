...
class ScoreTrackUpdate(object):
    ...
    def __init__(self, title=None, default=None, state=None, synchronization_points=None, local_vars_configuration=None):  # noqa: E501
        """ScoreTrackUpdate - a model defined in OpenAPI"""  # noqa: E501
