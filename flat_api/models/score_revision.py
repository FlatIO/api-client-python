...
class ScoreRevision(object):
    ...
    """
    def __init__(self, id=None, user=None, collaborators=None, creation_date=None, description=None, autosave=None, statistics=None):
        """
        ScoreRevision - a model defined in Swagger
