...
class CollectionContents(BaseModel):
    ...
    """ # noqa: E501
    scores_count: StrictInt = Field(description="The number of scores in the collection", alias="scoresCount")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["scoresCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scoresCount": obj.get("scoresCount")
        })
