...
class ScoreCreationBuilderData(object):
    ...
    def __init__(self, score_data=None, layout_data=None, local_vars_configuration=None):  # noqa: E501
    ...
    def score_data(self, score_data):
        ...
        """
        if self.local_vars_configuration.client_side_validation and score_data is None:  # noqa: E501
            raise ValueError("Invalid value for `score_data`, must not be `None`")  # noqa: E501
