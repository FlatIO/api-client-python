...
class TaskResult(BaseModel):
    ...
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="URL of the generated file, when the task produces one")
    error: Optional[StrictStr] = Field(default=None, description="Error message, when the task failed")
