...
class UserCreation(object):
    ...
    def __init__(self, username=None, email=None, password=None, locale=None):
        """
        UserCreation - a model defined in Swagger
        """
    ...
    def username(self, username):
        ...
        if username is not None and not re.search('^[A-Za-z0-9-_.]+$', username):
