...
class ScoreCommentContext(BaseModel):
    ...
    staff_idx: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="(Deprecated, use `staffUuid`) The identifier of the staff", alias="staffIdx")
    staff_uuid: Optional[StrictStr] = Field(default=None, description="The unique identifier (UUID) of the staff", alias="staffUuid")
