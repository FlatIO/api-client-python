...
class GroupDetails(object):
    ...
    def __init__(self, id=None, name=None, type=None, organization=None, creation_date=None, users_count=None, read_only=None, local_vars_configuration=None):  # noqa: E501
