...
class EduResourceMove(BaseModel):
    ...
    """ # noqa: E501
    destination: StrictStr = Field(description="Unique identifier of the destination folder for this resource. This can also be `root` to move the resource at the root of the user resource library. ")
