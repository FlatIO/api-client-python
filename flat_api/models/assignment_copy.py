...
class AssignmentCopy(object):
    ...
    def __init__(self, classroom=None):  # noqa: E501
        """AssignmentCopy - a model defined in Swagger"""  # noqa: E501
    ...
    def classroom(self, classroom):
        ...
        if classroom is None:
            raise ValueError("Invalid value for `classroom`, must not be `None`")  # noqa: E501
