...
class ScoreTrack(object):
    ...
    def __init__(self, id=None, title=None, score=None, creator=None, creation_date=None, modification_date=None, default=None, state=None, type=None, url=None, media_id=None, synchronization_points=None, local_vars_configuration=None):  # noqa: E501
