...
class Group(object):
    ...
    """
    def __init__(self, id=None, name=None, type=None, users_count=None, read_only=None, organization=None, creation_date=None):
        """
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["generic", "classTeachers", "classStudents"]
