...
class ResourceCollaboratorCreation(object):
    ...
    def __init__(self, user=None, group=None, user_email=None, user_token=None, acl_read=True, acl_write=False, acl_admin=False, local_vars_configuration=None):  # noqa: E501
