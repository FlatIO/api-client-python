...
class ScoreModification(object):
    ...
    def __init__(self, title=None, subtitle=None, composer=None, lyricist=None, arranger=None, privacy=None, sharing_key=None, description=None, tags=None, creation_type=None, license=None, license_text=None, local_vars_configuration=None):  # noqa: E501
    ...
    def sharing_key(self, sharing_key):
        ...
        if (self.local_vars_configuration.client_side_validation and
                sharing_key is not None and not re.search(r'^[a-f0-9]{128}$', sharing_key)):  # noqa: E501
            raise ValueError(r"Invalid value for `sharing_key`, must be a follow pattern or equal to `/^[a-f0-9]{128}$/`")  # noqa: E501
