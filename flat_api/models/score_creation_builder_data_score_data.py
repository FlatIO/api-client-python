...
class ScoreCreationBuilderDataScoreData(object):
    ...
    def __init__(self, use_tab_staff=None, use_chord_grid=None, fifths=None, nb_beats=None, beat_type=None, instruments=None, local_vars_configuration=None):  # noqa: E501
