...
class UserPublic(object):
    ...
    def __init__(self, username=None, picture=None, followers_count=None, firstname=None, is_power_user=None, lastname=None, html_url=None, following_count=None, liked_scores_count=None, printable_name=None, bio=None, id=None, name=None, is_flat_team=None, organization_role=None, profile_theme=None, cover_picture=None, owned_public_scores_count=None, instruments=None, class_role=None, organization=None, type=None, registration_date=None, local_vars_configuration=None):  # noqa: E501
