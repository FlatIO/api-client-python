...
class ScoreSummary(object):
    ...
    """
    def __init__(self, id=None, sharing_key=None, title=None, privacy=None, user=None, html_url=None):
        """
        ScoreSummary - a model defined in Swagger
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ScoreSummary):
            return False
