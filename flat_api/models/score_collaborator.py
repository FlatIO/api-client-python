...
class ScoreCollaborator(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, id=None, score=None, user=None, group=None, user_email=None, acl_read=True, acl_write=False, acl_admin=False):
        """
        ScoreCollaborator - a model defined in Swagger
    ...
    def id(self):
        """
        Gets the id of this ScoreCollaborator.
        The unique identifier of the score permission

        :return: The id of this ScoreCollaborator.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this ScoreCollaborator.
        The unique identifier of the score permission

        :param id: The id of this ScoreCollaborator.
        :type: str
        """
    ...
    def score(self):
        """
        Gets the score of this ScoreCollaborator.
        The unique identifier of the score

        :return: The score of this ScoreCollaborator.
        :rtype: str
        """
        return self._score
    ...
    def score(self, score):
        """
        Sets the score of this ScoreCollaborator.
        The unique identifier of the score

        :param score: The score of this ScoreCollaborator.
        :type: str
        """
    ...
    def user(self):
        """
        Gets the user of this ScoreCollaborator.

        :return: The user of this ScoreCollaborator.
        :rtype: UserPublic
        """
        return self._user
    ...
    def user(self, user):
        """
        Sets the user of this ScoreCollaborator.

        :param user: The user of this ScoreCollaborator.
        :type: UserPublic
        """
    ...
    def group(self):
        """
        Gets the group of this ScoreCollaborator.

        :return: The group of this ScoreCollaborator.
        :rtype: Group
        """
        return self._group
    ...
    def group(self, group):
        """
        Sets the group of this ScoreCollaborator.

        :param group: The group of this ScoreCollaborator.
        :type: Group
        """
    ...
    def user_email(self):
        """
        Gets the user_email of this ScoreCollaborator.
        If the collaborator is not a user of Flat yet, this field will contain his email. 

        :return: The user_email of this ScoreCollaborator.
        :rtype: str
        """
    ...
    def user_email(self, user_email):
        """
        Sets the user_email of this ScoreCollaborator.
        If the collaborator is not a user of Flat yet, this field will contain his email. 

        :param user_email: The user_email of this ScoreCollaborator.
        :type: str
        """
    ...
    def acl_read(self, acl_read):
        """
        Sets the acl_read of this ScoreCollaborator.
        `True` if the related user can read the score. (probably true if the user has a permission on the document). 

        :param acl_read: The acl_read of this ScoreCollaborator.
        :type: bool
        """
    ...
    def acl_write(self):
        """
        Gets the acl_write of this ScoreCollaborator.
        `True` if the related user can modify the score. 

        :return: The acl_write of this ScoreCollaborator.
        :rtype: bool
        """
    ...
    def acl_write(self, acl_write):
        """
        Sets the acl_write of this ScoreCollaborator.
        `True` if the related user can modify the score. 

        :param acl_write: The acl_write of this ScoreCollaborator.
        :type: bool
        """
    ...
    def acl_admin(self):
        """
        Gets the acl_admin of this ScoreCollaborator.
        ...
        :return: The acl_admin of this ScoreCollaborator.
        :rtype: bool
        """
    ...
    def acl_admin(self, acl_admin):
        """
        Sets the acl_admin of this ScoreCollaborator.
        `True` if the related user can can manage the current document, i.e. changing the document permissions and deleting the document 

        :param acl_admin: The acl_admin of this ScoreCollaborator.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ScoreCollaborator):
            return False
