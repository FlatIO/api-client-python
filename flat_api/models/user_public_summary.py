...
class UserPublicSummary(object):
    ...
    def __init__(self, username=None, picture=None, name=None, firstname=None, is_power_user=None, is_flat_team=None, lastname=None, html_url=None, printable_name=None, organization_role=None, class_role=None, organization=None, type=None, id=None, local_vars_configuration=None):  # noqa: E501
