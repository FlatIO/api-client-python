...
class ClassDetailsClever(object):
    ...
    def __init__(self, id=None, creation_date=None, modification_date=None, subject=None, term_name=None, term_start_date=None, term_end_date=None):
        """
        ClassDetailsClever - a model defined in Swagger
        """
