...
class ClassApi(object):
    ...
    def copy_assignment(self, _class, assignment, assignment_copy, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.copy_assignment(_class, assignment, assignment_copy, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str _class: Unique identifier of the class (required)
        :param str assignment: Unique identifier of the assignment (required)
        :param AssignmentCopy assignment_copy: (required)
        :return: Assignment
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.copy_assignment_with_http_info(_class, assignment, assignment_copy, **kwargs)  # noqa: E501
        else:
            (data) = self.copy_assignment_with_http_info(_class, assignment, assignment_copy, **kwargs)  # noqa: E501
            return data

    def copy_assignment_with_http_info(self, _class, assignment, assignment_copy, **kwargs):  # noqa: E501
        """Copy an assignment  # noqa: E501

        Copy an assignment to a specified class.  If the original assignment has a due date in the past, this new assingment will be created without a due date.  If the new class is synchronized with an external app (e.g. Google Classroom), the copied assignment will also be posted on the external app.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.copy_assignment_with_http_info(_class, assignment, assignment_copy, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['_class', 'assignment', 'assignment_copy']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'assignment_copy' is set
        if ('assignment_copy' not in local_var_params or
                local_var_params['assignment_copy'] is None):
            raise ValueError("Missing the required parameter `assignment_copy` when calling `copy_assignment`")  # noqa: E501
        ...
        body_params = None
        if 'assignment_copy' in local_var_params:
            body_params = local_var_params['assignment_copy']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def create_assignment(self, _class, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str _class: Unique identifier of the class (required)
        :param AssignmentCreation assignment_creation:
        :return: Assignment
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def create_assignment_with_http_info(self, _class, **kwargs):  # noqa: E501
        ...
        all_params = ['_class', 'assignment_creation']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        body_params = None
        if 'assignment_creation' in local_var_params:
            body_params = local_var_params['assignment_creation']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def create_class(self, class_creation, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_class(class_creation, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ClassCreation class_creation: (required)
        :return: ClassDetails
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_class_with_http_info(class_creation, **kwargs)  # noqa: E501
        else:
            (data) = self.create_class_with_http_info(class_creation, **kwargs)  # noqa: E501
            return data

    def create_class_with_http_info(self, class_creation, **kwargs):  # noqa: E501
        """Create a new class  # noqa: E501

        Classrooms on Flat allow you to create activities with assignments and post content to a specific group.  When creating a class, Flat automatically creates two groups: one for the teachers of the course, one for the students. The creator of this class is automatically added to the teachers group.  If the classsroom is synchronized with another application like Google Classroom, some of the meta information will automatically be updated.  You can add users to this class using `POST /classes/{class}/users/{user}`, they will automatically added to the group based on their role on Flat. Users can also enroll themselves to this class using `POST /classes/enroll/{enrollmentCode}` and the `enrollmentCode` returned in the `ClassDetails` response.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_class_with_http_info(class_creation, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['class_creation']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            ...
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'class_creation' is set
        if ('class_creation' not in local_var_params or
                local_var_params['class_creation'] is None):
            raise ValueError("Missing the required parameter `class_creation` when calling `create_class`")  # noqa: E501
        ...
        body_params = None
        if 'class_creation' in local_var_params:
            body_params = local_var_params['class_creation']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def create_submission(self, _class, assignment, assignment_submission_update, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_submission(_class, assignment, assignment_submission_update, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str _class: Unique identifier of the class (required)
        :param str assignment: Unique identifier of the assignment (required)
        :param AssignmentSubmissionUpdate assignment_submission_update: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_submission_with_http_info(_class, assignment, assignment_submission_update, **kwargs)  # noqa: E501
        else:
            (data) = self.create_submission_with_http_info(_class, assignment, assignment_submission_update, **kwargs)  # noqa: E501
            return data

    def create_submission_with_http_info(self, _class, assignment, assignment_submission_update, **kwargs):  # noqa: E501
        """Create or edit a submission  # noqa: E501

        Use this method as a student to create, update and submit a submission related to an assignment. Students can only set `attachments`, `studentComment` and `submit`.  Teachers can use `PUT /classes/{class}/assignments/{assignment}/submissions/{submission}` to update a submission by id.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_submission_with_http_info(_class, assignment, assignment_submission_update, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['_class', 'assignment', 'assignment_submission_update']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'assignment_submission_update' is set
        if ('assignment_submission_update' not in local_var_params or
                local_var_params['assignment_submission_update'] is None):
            raise ValueError("Missing the required parameter `assignment_submission_update` when calling `create_submission`")  # noqa: E501
        ...
        body_params = None
        if 'assignment_submission_update' in local_var_params:
            body_params = local_var_params['assignment_submission_update']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def edit_submission(self, _class, assignment, submission, assignment_submission_update, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.edit_submission(_class, assignment, submission, assignment_submission_update, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.edit_submission_with_http_info(_class, assignment, submission, assignment_submission_update, **kwargs)  # noqa: E501
        else:
            (data) = self.edit_submission_with_http_info(_class, assignment, submission, assignment_submission_update, **kwargs)  # noqa: E501
            return data

    def edit_submission_with_http_info(self, _class, assignment, submission, assignment_submission_update, **kwargs):  # noqa: E501
        """Edit a submission  # noqa: E501

        Use this method as a teacher to update the different submission and give feedback. Teachers can only set `returnFeedback`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.edit_submission_with_http_info(_class, assignment, submission, assignment_submission_update, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['_class', 'assignment', 'submission', 'assignment_submission_update']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('assignment_submission_update' not in local_var_params or
                local_var_params['assignment_submission_update'] is None):
            raise ValueError("Missing the required parameter `assignment_submission_update` when calling `edit_submission`")  # noqa: E501
    ...
    def update_class(self, _class, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str _class: Unique identifier of the class (required)
        :param ClassUpdate class_update: Details of the Class
        :return: ClassDetails
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_class_with_http_info(self, _class, **kwargs):  # noqa: E501
        ...
        all_params = ['_class', 'class_update']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        body_params = None
        if 'class_update' in local_var_params:
            body_params = local_var_params['class_update']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
