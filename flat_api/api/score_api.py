...
class ScoreApi(object):
    ...
    def add_score_collaborator(self, score, resource_collaborator_creation, **kwargs):  # noqa: E501
        ...
        >>> thread = api.add_score_collaborator(score, resource_collaborator_creation, async_req=True)
        >>> result = thread.get()
        ...
        :param ResourceCollaboratorCreation resource_collaborator_creation: (required)
        ...
        if kwargs.get('async_req'):
            return self.add_score_collaborator_with_http_info(score, resource_collaborator_creation, **kwargs)  # noqa: E501
        else:
            (data) = self.add_score_collaborator_with_http_info(score, resource_collaborator_creation, **kwargs)  # noqa: E501
            return data

    def add_score_collaborator_with_http_info(self, score, resource_collaborator_creation, **kwargs):  # noqa: E501
        """Add a new collaborator  # noqa: E501

        Share a score with a single user or a group. This API call allows to add, invite and update the collaborators of a resource. - To add an existing Flat user to the resource, specify its unique identifier in the `user` property. - To invite an external user to the resource, specify its email in the `userEmail` property. - To add a Flat group to the resource, specify its unique identifier in the `group` property. - To update an existing collaborator, process the same request with different rights.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_score_collaborator_with_http_info(score, resource_collaborator_creation, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['score', 'resource_collaborator_creation']  # noqa: E501
        ...
        # verify the required parameter 'resource_collaborator_creation' is set
        if ('resource_collaborator_creation' not in local_var_params or
                local_var_params['resource_collaborator_creation'] is None):
            raise ValueError("Missing the required parameter `resource_collaborator_creation` when calling `add_score_collaborator`")  # noqa: E501
        ...
        body_params = None
        if 'resource_collaborator_creation' in local_var_params:
            body_params = local_var_params['resource_collaborator_creation']
        # HTTP header `Accept`
    ...
    def add_score_track(self, score, score_track_creation, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_score_track(score, score_track_creation, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str score: Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`).  (required)
        :param ScoreTrackCreation score_track_creation: (required)
        :return: ScoreTrack
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.add_score_track_with_http_info(score, score_track_creation, **kwargs)  # noqa: E501
        else:
            (data) = self.add_score_track_with_http_info(score, score_track_creation, **kwargs)  # noqa: E501
            return data

    def add_score_track_with_http_info(self, score, score_track_creation, **kwargs):  # noqa: E501
        """Add a new video or audio track to the score  # noqa: E501

        Use this method to add new track to the score. This track can then be played on flat.io or in an embedded score. This API method support medias hosted on SoundCloud, YouTube and Vimeo.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_score_track_with_http_info(score, score_track_creation, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['score', 'score_track_creation']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'score_track_creation' is set
        if ('score_track_creation' not in local_var_params or
                local_var_params['score_track_creation'] is None):
            raise ValueError("Missing the required parameter `score_track_creation` when calling `add_score_track`")  # noqa: E501
        ...
        body_params = None
        if 'score_track_creation' in local_var_params:
            body_params = local_var_params['score_track_creation']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def create_score(self, score_creation, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_score(score_creation, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ScoreCreation score_creation: (required)
        :return: ScoreDetails
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_score_with_http_info(score_creation, **kwargs)  # noqa: E501
        else:
            (data) = self.create_score_with_http_info(score_creation, **kwargs)  # noqa: E501
            return data

    def create_score_with_http_info(self, score_creation, **kwargs):  # noqa: E501
        """Create a new score  # noqa: E501

        Use this API method to **create a new music score in the current User account**. You will need a MusicXML 3 (`vnd.recordare.musicxml` or `vnd.recordare.musicxml+xml`), a MIDI (`audio/midi`), Guitar Pro (GP3, GP4, GP5, GPX, GP), PowerTab or TuxGuitar file to create the new Flat document.  This API call will automatically create the first revision of the document, the score can be modified by the using our web application or by uploading a new revision of this file (`POST /v2/scores/{score}/revisions/{revision}`).  The currently authenticated user will be granted owner of the file and will be able to add other collaborators (users and groups).  If no `collection` is specified, the API will create the score in the most appropriate collection. This can be the `root` collection or a different collection based on the user's settings or API authentication method. If a `collection` is specified and this one has more public privacy settings than the score (e.g. `public` vs `private` for the score), the privacy settings of the created score will be adjusted to the collection ones. You can check the adjusted privacy settings in the returned score `privacy`, and optionally adjust these settings if needed using `PUT /scores/{score}`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_score_with_http_info(score_creation, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['score_creation']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            ...
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'score_creation' is set
        if ('score_creation' not in local_var_params or
                local_var_params['score_creation'] is None):
            raise ValueError("Missing the required parameter `score_creation` when calling `create_score`")  # noqa: E501
        ...
        body_params = None
        if 'score_creation' in local_var_params:
            body_params = local_var_params['score_creation']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def create_score_revision(self, score, score_revision_creation, **kwargs):  # noqa: E501
        """Create a new revision  # noqa: E501

        Update a score by uploading a new revision for this one.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_score_revision(score, score_revision_creation, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str score: Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`).  (required)
        :param ScoreRevisionCreation score_revision_creation: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_score_revision_with_http_info(score, score_revision_creation, **kwargs)  # noqa: E501
        else:
            (data) = self.create_score_revision_with_http_info(score, score_revision_creation, **kwargs)  # noqa: E501
            return data

    def create_score_revision_with_http_info(self, score, score_revision_creation, **kwargs):  # noqa: E501
        """Create a new revision  # noqa: E501

        Update a score by uploading a new revision for this one.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_score_revision_with_http_info(score, score_revision_creation, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['score', 'score_revision_creation']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'score_revision_creation' is set
        if ('score_revision_creation' not in local_var_params or
                local_var_params['score_revision_creation'] is None):
            raise ValueError("Missing the required parameter `score_revision_creation` when calling `create_score_revision`")  # noqa: E501
        ...
        body_params = None
        if 'score_revision_creation' in local_var_params:
            body_params = local_var_params['score_revision_creation']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def edit_score(self, score, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str score: Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`).  (required)
        :param ScoreModification score_modification:
        :return: ScoreDetails
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def edit_score_with_http_info(self, score, **kwargs):  # noqa: E501
        ...
        all_params = ['score', 'score_modification']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        body_params = None
        if 'score_modification' in local_var_params:
            body_params = local_var_params['score_modification']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def fork_score(self, score, score_fork, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fork_score(score, score_fork, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str score: Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`).  (required)
        :param ScoreFork score_fork: (required)
        :param str sharing_key: This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. 
        :return: ScoreDetails
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.fork_score_with_http_info(score, score_fork, **kwargs)  # noqa: E501
        else:
            (data) = self.fork_score_with_http_info(score, score_fork, **kwargs)  # noqa: E501
            return data

    def fork_score_with_http_info(self, score, score_fork, **kwargs):  # noqa: E501
        """Fork a score  # noqa: E501

        This API call will make a copy of the last revision of the specified score and create a new score. The copy of the score will have a privacy set to `private`.  When using a [Flat for Education](https://flat.io/edu) account, the inline and contextualized comments will be accessible in the child document.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fork_score_with_http_info(score, score_fork, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['score', 'score_fork', 'sharing_key']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'score_fork' is set
        if ('score_fork' not in local_var_params or
                local_var_params['score_fork'] is None):
            raise ValueError("Missing the required parameter `score_fork` when calling `fork_score`")  # noqa: E501
        ...
        body_params = None
        if 'score_fork' in local_var_params:
            body_params = local_var_params['score_fork']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def get_score_revision_data_with_http_info(self, score, revision, format, **kwargs):  # noqa: E501
        ...
        if 'only_cached' in local_var_params:
            query_params.append(('onlyCached', local_var_params['only_cached']))  # noqa: E501
    ...
    def post_score_comment(self, score, score_comment_creation, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_score_comment(score, score_comment_creation, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str score: Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`).  (required)
        :param ScoreCommentCreation score_comment_creation: (required)
        :param str sharing_key: This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. 
        :return: ScoreComment
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_score_comment_with_http_info(score, score_comment_creation, **kwargs)  # noqa: E501
        else:
            (data) = self.post_score_comment_with_http_info(score, score_comment_creation, **kwargs)  # noqa: E501
            return data

    def post_score_comment_with_http_info(self, score, score_comment_creation, **kwargs):  # noqa: E501
        """Post a new comment  # noqa: E501

        Post a document or a contextualized comment on a document.  Please note that this method includes an anti-spam system for public scores. We don't guarantee that your comments will be accepted and displayed to end-user. Comments are be blocked by returning a `403` HTTP error and hidden from other users when the `spam` property is `true`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_score_comment_with_http_info(score, score_comment_creation, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['score', 'score_comment_creation', 'sharing_key']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'score_comment_creation' is set
        if ('score_comment_creation' not in local_var_params or
                local_var_params['score_comment_creation'] is None):
            raise ValueError("Missing the required parameter `score_comment_creation` when calling `post_score_comment`")  # noqa: E501
        ...
        body_params = None
        if 'score_comment_creation' in local_var_params:
            body_params = local_var_params['score_comment_creation']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def update_score_comment(self, score, comment, score_comment_update, **kwargs):  # noqa: E501
        """Update an existing comment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_score_comment(score, comment, score_comment_update, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str score: Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`).  (required)
        :param str comment: Unique identifier of a sheet music comment  (required)
        :param ScoreCommentUpdate score_comment_update: (required)
        :param str sharing_key: This sharing key must be specified to access to a score or collection with a `privacy` mode set to `privateLink` and the current user is not a collaborator of the document. 
        :return: ScoreComment
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_score_comment_with_http_info(score, comment, score_comment_update, **kwargs)  # noqa: E501
        else:
            (data) = self.update_score_comment_with_http_info(score, comment, score_comment_update, **kwargs)  # noqa: E501
            return data

    def update_score_comment_with_http_info(self, score, comment, score_comment_update, **kwargs):  # noqa: E501
        """Update an existing comment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_score_comment_with_http_info(score, comment, score_comment_update, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['score', 'comment', 'score_comment_update', 'sharing_key']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'score_comment_update' is set
        if ('score_comment_update' not in local_var_params or
                local_var_params['score_comment_update'] is None):
            raise ValueError("Missing the required parameter `score_comment_update` when calling `update_score_comment`")  # noqa: E501
        ...
        body_params = None
        if 'score_comment_update' in local_var_params:
            body_params = local_var_params['score_comment_update']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def update_score_track(self, score, track, score_track_update, **kwargs):  # noqa: E501
        """Update an audio or video track linked to a score  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_score_track(score, track, score_track_update, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str score: Unique identifier of the score document. This can be a Flat Score unique identifier (i.e. `ScoreDetails.id`) or, if the score is also a Google Drive file, the Drive file unique identifier prefixed with `drive-` (e.g. `drive-0B000000000`).  (required)
        :param str track: Unique identifier of a score audio track  (required)
        :param ScoreTrackUpdate score_track_update: (required)
        :return: ScoreTrack
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_score_track_with_http_info(score, track, score_track_update, **kwargs)  # noqa: E501
        else:
            (data) = self.update_score_track_with_http_info(score, track, score_track_update, **kwargs)  # noqa: E501
            return data

    def update_score_track_with_http_info(self, score, track, score_track_update, **kwargs):  # noqa: E501
        """Update an audio or video track linked to a score  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_score_track_with_http_info(score, track, score_track_update, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['score', 'track', 'score_track_update']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'score_track_update' is set
        if ('score_track_update' not in local_var_params or
                local_var_params['score_track_update'] is None):
            raise ValueError("Missing the required parameter `score_track_update` when calling `update_score_track`")  # noqa: E501
        ...
        body_params = None
        if 'score_track_update' in local_var_params:
            body_params = local_var_params['score_track_update']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
