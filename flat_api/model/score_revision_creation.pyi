...
class ScoreRevisionCreation(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["data", "dataEncoding", "autosave", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["data", "dataEncoding", "autosave", "description", ], str]):
