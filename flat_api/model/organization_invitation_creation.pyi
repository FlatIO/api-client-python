...
class OrganizationInvitationCreation(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "organizationRole", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "organizationRole", ], str]):
