...
class GroupDetails(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "type", "organization", "creationDate", "usersCount", "readOnly", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "type", "organization", "creationDate", "usersCount", "readOnly", ], str]):
