...
class EduResourceUseInClass(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["classroom", "assignment", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["classroom", "assignment", ], str]):
