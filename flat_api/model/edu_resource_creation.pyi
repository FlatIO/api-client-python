...
class EduResourceCreation(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "title", "parent", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "title", "parent", ], str]):
