...
class MicrosoftGraphSubmission(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "state", "alternateLink", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "state", "alternateLink", ], str]):
