...
class MicrosoftGraphAssignment(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "state", "alternateLink", "categories", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "state", "alternateLink", "categories", ], str]):
