...
class ScoreCommentCreation(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["comment", "revision", "rawComment", "mentions", "replyTo", "context", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["comment", "revision", "rawComment", "mentions", "replyTo", "context", ], str]):
