...
------------ | ------------- | ------------- | -------------
**destination** | **str** | Unique identifier of the destination folder for the copy. This can also be &#x60;root&#x60; to copy the resource at the root of the user resource library.  | 
...
edu_resource_copy_from_dict = EduResourceCopy.from_dict(edu_resource_copy_dict)
```
