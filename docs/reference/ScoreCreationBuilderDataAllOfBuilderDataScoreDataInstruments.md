...
------------ | ------------- | ------------- | -------------
**group** | **str** | The identifier of the instrument group (e.g. &#x60;keyboards&#x60;, &#x60;brass&#x60;) | 
...
**has_quarter_tone** | **bool** | True if the part can use quarter tones (prevents the part from having a TAB staff or chord grid) | [optional] 
