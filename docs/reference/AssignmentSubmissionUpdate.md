...
**playback** | [**List[AssignmentSubmissionPlayback]**](AssignmentSubmissionPlayback.md) |  | [optional] 
...
**var_return** | **bool** | If &#x60;true&#x60;, the submission will be returned to the student (teachers only) | [optional] 
