...
**mode** | **str** | Deployment-based LTI 1.3 configuration mode | [optional] 
...
json = "{}"
# create an instance of LtiConfiguration1p3Deployment from a JSON string
lti_configuration1p3_deployment_instance = LtiConfiguration1p3Deployment.from_json(json)
# print the JSON string representation of the object
print(LtiConfiguration1p3Deployment.to_json())

# convert the object into a dict
lti_configuration1p3_deployment_dict = lti_configuration1p3_deployment_instance.to_dict()
# create an instance of LtiConfiguration1p3Deployment from a dict
lti_configuration1p3_deployment_from_dict = LtiConfiguration1p3Deployment.from_dict(lti_configuration1p3_deployment_dict)
```
