...
**can_change_privacy** | **bool** | Whether the current user can change the privacy of this resource (e.g. to share as &#x60;organizationPublic&#x60; or unshare it with &#x60;private&#x60;)  | [optional] 
...
edu_resource_capabilities_from_dict = EduResourceCapabilities.from_dict(edu_resource_capabilities_dict)
```
