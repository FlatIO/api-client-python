...
json = "{}"
# create an instance of LtiConfiguration from a JSON string
lti_configuration_instance = LtiConfiguration.from_json(json)
# print the JSON string representation of the object
print(LtiConfiguration.to_json())

# convert the object into a dict
lti_configuration_dict = lti_configuration_instance.to_dict()
# create an instance of LtiConfiguration from a dict
lti_configuration_from_dict = LtiConfiguration.from_dict(lti_configuration_dict)
```
