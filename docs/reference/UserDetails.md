...
**cover_picture** | **str** | Cover picture (background) for the profile | [optional] 
...
**private_profile** | **bool** | Whether this user profile is private (individual accounts only) | [optional] 
