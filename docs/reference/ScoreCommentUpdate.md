...
------------ | ------------- | ------------- | -------------
**revision** | **str** | The unique identifier of the revision of the score where the comment was added. If this property is unspecified or contains \&quot;last\&quot;, the API will automatically take the last revision created.  | [optional] 
**comment** | **str** | The comment text that can include mentions using the following format: &#x60;@[id:username]&#x60;.  | [optional] 
